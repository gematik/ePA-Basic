...
link:https://github.com/gematik/ePA-XDS-Document/tree/ePA-3.0.2/concept[Dokumentenmanagement (XDS Document Service)]
...
link:https://github.com/gematik/ePA-Medication/tree/ePA-3.0.2/concept[Medikationsprozess (Medication Service)]
