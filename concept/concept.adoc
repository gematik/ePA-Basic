...
ifdef::backend-pdf[]
[.metadata]
//Version: 3.1.3 Release, 01.08.2025
endif::[]
...
Der Zustand "Maintenance" ist ein Zustand, der vom Aktensystem gesetzt wird, wenn eine Akte aufgrund von Wartungsarbeiten nicht verfügbar ist.
