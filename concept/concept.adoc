...
ifdef::backend-pdf[]
[.metadata]
//Version: 3.1.3-1 Release, 15.12.2025
endif::[]
...
|01.08.2025
|6
|Veröffentlichung zur Kommentierung; Ergänzung Elektronischer Medikationsplan und XDS Document Service
|gematik
...
|15.12.2025
|
|Anpassung der Legal Policy - keine Leserechte für Ärzt:innen; Veröffentlichung
|gematik

|3.1.3-2
|06.02.2026
|
|Kapitel Push Notification Management: Aktualisierung des Links auf das Konzept des Push Features (main)
|gematik
|===
toc::[]
...
Der Zustand "Inaccessible" ist ein Zustand, der vom Aktensystem gesetzt wird, wenn eine Akte aufgrund von Wartungsarbeiten oder Inkonsistenzen nicht verfügbar ist.
...
Die ePA für alle unterstützt eine dokumentenzentrierte Arbeit über drei Dienste.

* XDS Document Service
* Constraint Mangement
* MHD Service

ifndef::env-github[]
include::chapters/xds_doc_service.adoc[]
endif::[]
ifdef::env-github[]
link:./chapters/xds_doc_service.adoc[XDS Document Service]
endif::[]
...
Die ePA unterstützt verschiedene Versorgungsprozesse mittels dedizierter Medical Services. Initial unterstützt die Fachanwendung ePA den *digital gestützten Medikationsprozess* (dgMP).


ifndef::env-github[]
include::chapters/medication_service.adoc[]
endif::[]
ifdef::env-github[]
link:./chapters/medication_service.adoc[digital gestützter Medikationsprozess]
endif::[]
