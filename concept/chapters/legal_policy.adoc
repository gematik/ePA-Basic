...
|Ergebnisse datengestützter Auswertungen der Krankenkassen zu individuellen Gesundheitsrisiken gemäß § 25b SGB V
^|-
^|-
^|-
^|-
...
15.1+^h|Medical Services «FHIR Data Services»

|15
|medication +
(Medication Service)
|Verordnungs-, Dispensier- und Medikationsdaten in einer elektronischen Medikationsliste (eML) und einem elektronischen Medikationsplan (eMP)
^|CRUD
^|CRUD
^|R
^|R
...
|Bereitstellung demographischer Daten des Versicherten für Medical Services
^|-
^|-
^|-
^|-
...
|documents +
(MHD Service)
| Suche & Bereitstellung (medizinischer) Dokumente aus dem XDS Document Service
^|R
^|R
^|R
^|R
...
|audit +
(Audit Event Service)
|Protokolle von Zugriffen aller Nutzer auf die Akte des Versicherten
^|-
^|-
^|-
^|-
...
(**) Ein Versicherter bzw. sein Vertreter sowie die Ombudsstelle kann, durch Setzen eines Widerspruchs gegen das Einstellen von Verordnungsdaten und Dispensierinformation durch den E-Rezept-Fachdienst (erp-submission), das Löschen der im FHIR data service medication gespeicherten Daten erzwingen.
