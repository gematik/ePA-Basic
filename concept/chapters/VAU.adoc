...
* *Secure Admin Storage Key* für die Befugnisse 
...
Für die Ableitung des versichertenindividuellen *Secure Admin Storage Key* prüft das HSM lediglich, dass es sich um eine attestierte VAU handelt.
